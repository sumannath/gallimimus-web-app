        ...
        <div class="col-lg-12 col-xl-12">
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-4">
                    ...
                    <button type="button" class="btn btn-primary" style="position: fixed; bottom: 50px; right: 20px; z-index: 100" id="download"><i class="fa fa-download"></i> Download Package</button>
                </div>
            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="media d-flex">
                                                                <div class="align-self-center">
                                                                    <img src="{{ $application->icon }}" width="80" />
                                                                </div>
                                                            ...
                                                            <div class="row skin skin-polaris">
                                                                <div class="col-md-6 col-sm-12">
                                                                    <fieldset>
                                                                        <input type="checkbox" name="apps[]" id="input-{{ $loop->parent->index }}{{ $loop->index }}" value="{{ $application->id }}">
                                                                        <label for="input-{{ $loop->parent->index }}{{ $loop->index }}" class="white">Add this</label>
                                                                    </fieldset>
                                                                </div>
                                                            </div>
                                                        </div>
